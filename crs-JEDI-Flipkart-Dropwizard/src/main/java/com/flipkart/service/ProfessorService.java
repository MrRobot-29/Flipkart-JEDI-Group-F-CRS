...
public interface ProfessorService {
	 ...
	 */
	public List<Course> viewCourseList(int instructorId) throws NoCourseFoundException;
	 ...
	 */
	public List<Student> viewEnrolledStudents(int instructorId,String courseId) throws NoStudentFoundException;
